\def\ProblemCode{SEGPERS}
\def\ProblemTitle{Persistent Segment Tree}
...
\begin{itemize}
    \item \boxed{1\ v\ i\ k}:
    Từ phiên bản $v$, tạo ra một phiên bản mới bằng cách tăng phần tử thứ $i$ lên $k$ đơn vị $(|k| \le 10^{9})$.
    \item \boxed{2\ v\ l\ r}:
